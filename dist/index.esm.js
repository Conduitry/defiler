...
import { watch, readdir as readdir$1, stat as stat$1, readFile as readFile$1 } from 'fs';
...
class Defiler {
    ...
    async get(_) {
        ...
        if (this._status === 1 && current && (typeof _ === 'function' || !this.files.has(_))) {
    ...
    resolve(path) {
        return this._resolver && typeof this._context.getStore() === 'string'
            ? this._resolver(this._context.getStore(), path)
            : path;
    }
    _start_wave() {
